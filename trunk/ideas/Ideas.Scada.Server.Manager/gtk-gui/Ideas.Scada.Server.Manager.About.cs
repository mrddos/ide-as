...
namespace Ideas.Scada.Server.Manager
{
	public partial class About
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Ideas.Scada.Server.Manager.About
			this.Name = "Ideas.Scada.Server.Manager.About";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child Ideas.Scada.Server.Manager.About.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child Ideas.Scada.Server.Manager.About.ActionArea
